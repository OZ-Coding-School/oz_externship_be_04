...
# Celery settings
CELERY_BROKER_URL = os.environ.get("CELERY_BROKER_URL", "redis://{REDIS_HOST}:6379/0")
CELERY_RESULT_BACKEND = os.environ.get("CELERY_RESULT_BACKEND", "{REDIS_HOST}:6379/1")
