...
class StudyLecture(TimeStampedModel):
    lecture = models.ForeignKey("lectures.CrawledLecture", on_delete=models.CASCADE, db_column="studylecture_lectures")
    study_group = models.ForeignKey(
        "study_groups.StudyGroup", on_delete=models.CASCADE, db_column="studylecture_study_groups"
    )
