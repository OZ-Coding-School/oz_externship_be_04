...
from apps.lectures.views.crawled_lecture_view import (
    CrawledLectureListAPIView,
    CrawledLectureRecommendAPIView,
)

urlpatterns = [
    path("/lectures", CrawledLectureListAPIView.as_view(), name="lectures"),
    path("/lectures/recommends", CrawledLectureRecommendAPIView.as_view(), name="recommends"),
