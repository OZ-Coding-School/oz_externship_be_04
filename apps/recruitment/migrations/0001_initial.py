# Generated by Django 5.2.8 on 2025-11-25 07:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name="Recruitment",
            fields=[
                ("id", models.BigAutoField(help_text="구인 공고 ID", primary_key=True, serialize=False)),
                ...
                (
                    "close_at",
                    models.DateTimeField(default=apps.recruitment.models.get_default_close_at, help_text="공고 마감일"),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="recruitments",
                        to="study_groups.studygroupbasemodel",
                    ),
                ),
            ],
            options={
